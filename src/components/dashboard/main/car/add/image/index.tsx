...
interface CarRentalAddImageProps {
    id: string
    token?: string
}
export const CarRentalAddImage = ({id, token}: CarRentalAddImageProps) => {
        ...
        <ContentCrud title="Image Car" titleAction="New Image Car">
            <Form {...form}>
                <form onSubmit={handleForm} className="h-full">
                                    ...
                                    <FormControl>
                                        <div className="w-full flex items-center justify-center">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Button onClick={() => setPreview("")} variant="destructive" size="sm" className="absolute top-0 -right-10 cursor-pointer rounded-l-none rounded-r-xl"><X size={40} /></Button>
                                             </div>
                                            ) : (
                        ...
                        />
                        <ButtonLoading type="submit" isLoading={isPending}>Add</ButtonLoading>
                </form>
            </Form>
        </ContentCrud>
    )
