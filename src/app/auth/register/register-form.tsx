...
export const RegisterForm = () => {
    ...
    return (
        <CardAuth backButtonHref="/auth/login" backButtonLabel="Already have an account?" headerLabel="Create an account">
            <Form {...form}>
                    ...
                    <div className="space-y-4">
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...field} placeholder="Example name" type="text" disabled={isPending} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
